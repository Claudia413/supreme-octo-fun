<template>
	<div class="hireme">
		...
		<section class="intro-text text-block">
			<h3>Hi there!</h3>
			<p>Curious to find out what we can build together? As a developer and adventurer I can always create custom work, but just to give you an idea of what I can do I've listed some of my favorite ways to help you below.</p>
			<p>Warning: working with me may result in cool websites, laughter and sparkles</p>
		</section>
		<img alt="Close up of Claudia Engelsman"
		...
		<section class="services text-block">
			...
			<ul>
				...
				<li>you can maintain yourself if you like (I can also help with this if you don't want to maintain it yourself)</li>
				<li>is optimized for accessibility to ensure all your customers, even those with a disability can access the information they need</li>
		...
		<section class="cause text-block">
			...
			<p>I believe in helping others and for that reason I have set up Code for a Cause. I will help non-profit organizations with their website for half a day per week for free. I will dedicate my skill and knowledge to build a new or rebuild an existing website in a new design for an organization fighting for a worthy cause. It may take a little longer than regular webdevelopment as it is just part-time, but it is for free, no strings attached.</p>
		...
		<section class="other text-block">
			...
			<p>Want to work together on something else? Just reach out, I love getting mail that's not a newsletter or spam so I'll be excited to hear from you!</p>
		</section>
