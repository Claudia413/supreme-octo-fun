  ...
  <div class="roadtrip">
    ...
    <header v-if="roadtrip.header.primary">
      ...
      <h1 class="header-title animate">
        ...
        }}<span class="header-subtitle animate">{{
          roadtrip.header.primary.subtitle[0].text
        }}</span>
      </h1>
    </header>
    ...
    <div class="content">
      <template v-for="(slice, index) in slices">
        ...
        <section
          v-if="slice.slice_type === 'image_and_2col_text'"
          class="story"
          :key="'slice-' + index"
        >
        ...
        <section
          v-if="slice.slice_type === 'text_and_carrousel'"
          :key="'slice-' + index"
          class="overlap-grid"
        >
          <div class="card-text animate">
